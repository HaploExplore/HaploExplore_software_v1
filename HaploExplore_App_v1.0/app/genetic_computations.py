...
def extend_haploblocks(haploblocks: List["Haploblock"], genomic_regions: List[List["SNPInformations"]], r_square_cut: float | None,
    d_prime_cut: float | None, maf_threshold: float | None, cp_cut: float | None, MAX_EMPTY_SNP_GAP_BETWEEN_TWO_SNPS_IN_A_BLOC: int | None) -> Tuple[List["Haploblock"], List[Tuple[str, int, int, int, int, int, int, int]]]:
    """
